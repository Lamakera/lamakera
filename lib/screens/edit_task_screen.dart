...
import 'package:lamakera/model/todo.dart';
...
class _EditTugasPageState extends State<EditTugasPage> {
  ...
  void initState() {
    super.initState();
    _taskController = TextEditingController(text: widget.todo.todoText);
    selectedCategory = widget.todo.category;
    isNotificationEnabled = widget.todo.notification == 1;
    _selectedDate = DateFormat('yyyy-MM-dd').parse(widget.todo.deadline);
  }
  ...
  void saveEditedTask() async {
    ...
    await DatabaseHelper().update(updatedTask.toMap());
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: AppTextStyles.subhead1Regular.copyWith(
                                color: AppColors.black,
                              ),
                              suffixIcon: Padding(
